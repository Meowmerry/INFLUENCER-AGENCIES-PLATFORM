...
import {
  ...
  InfluencerFormData,
  InfluencerRegister,
} from "./interface/influencer-interface-data";
import { registerInfluencer } from "../../services/api/register";
          ...
          <div className="mt-18 mx-auto max-h-full md:flex flex-row px-14 pb-16 pt-10 shadow-lg shadow-[#4998DD] bg-white border-solid border-1.5 rounded-lg border-gray-300">
            <form className="w-full" onSubmit={handleSubmit(onSubmit)}>
              ...
              <div className="inline-flex items-center">
                <div className="block uppercase tracking-wide text-gray-700 text-xs font-bold mr-12">
                  Channel Offer
                </div>
                <div className="flex justify-center">
                  <div className="form-check form-check-inline justify-center inline-flex items-center">
                    <input
                      id="chanelFacebook"
                      type="checkbox"
                    ...
                    <label
                      ...
                      className="ml-2 text-sm font-medium  mr-6"
                    >
                      <svg
                ...
                <div className="flex flex-wrap -mx-3 mb-6">
                  ...
                  <div className="w-full md:w-1/2 px-3">
                    <div className="eye_div">
                      ...
                      />
                      <div
                        className="icon_button absolute eye-icon"
